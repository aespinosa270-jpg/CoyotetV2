 ...
 * Mockea variables de entorno mínimas para que `getEnv()` no truene.
 */
import { beforeEach, vi } from "vitest";

// Variables de entorno mínimas para que el validador (env.ts) pase
...
(process.env as any).STRIPE_WEBHOOK_SECRET = "whsec_test1234567890";

(process.env as any).FACTURAPI_KEY = "sk_test_facturapi_fake1234567890";
