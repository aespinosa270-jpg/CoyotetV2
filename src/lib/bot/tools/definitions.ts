...
export const BOT_TOOLS: any[] = [
  ...
  },
  {
    ...
    parameters: {
      type: "object",
      properties: {
        monto: { type: "number", description: "Monto total exacto a cobrar en MXN. Si con_factura=true este monto DEBE incluir el IVA 16%." },
        monto_incluye_iva: { type: "boolean", description: "Marcar true si el monto ya tiene IVA incluido (viene de calcular_envio con requiere_factura=true)" },
  ...
  },
  {
    ...
    parameters: {
      type: "object",
      properties: {
        monto: { type: "number", description: "Monto total exacto. Si requiere factura DEBE incluir IVA 16%." },
        con_factura: { type: "boolean", description: "Si el cliente requiere factura fiscal" },
        monto_incluye_iva: { type: "boolean", description: "Marcar true si el monto ya tiene IVA incluido" },
        rfc: { type: "string" },
        razon_social: { type: "string" },
        cp_fiscal: { type: "string" },
        regimen_fiscal: { type: "string" },
