...
import { 
  ...
  MoreVertical, Filter, Volume2, Headphones,
  BarChart3, Hash, PhoneMissed, PhoneForwarded
} from 'lucide-react';
import { products } from '@/lib/products'; 

// --- MOCK DATA: Registro de Telefonía ---
const callLogs = [
  { id: "CALL-101", type: "saliente", agent: "Carlos M.", client: "Roberto García", company: "Tácticos Elite", duration: "05:12", status: "contestada", date: "Hoy, 12:45 PM", fabric: "prod_diablo" },
  { id: "CALL-102", type: "entrante", agent: "Ana S.", client: "Marcos Polo", company: "Uniformes Puebla", duration: "10:30", status: "contestada", date: "Hoy, 11:20 AM", fabric: "prod_sportok_escolar" },
  { id: "CALL-103", type: "saliente", agent: "Javier F.", client: "Ana Martínez", company: "Hoodie Lab", duration: "00:00", status: "no-contestada", date: "Hoy, 09:15 AM", fabric: "prod_felpa_china" },
  { id: "CALL-104", type: "entrante", agent: "Carlos M.", client: "Julio César", company: "Sportswear MX", duration: "08:45", status: "contestada", date: "Ayer, 4:50 PM", fabric: "prod_alaska" },
  { id: "CALL-105", type: "saliente", agent: "Ana S.", client: "Elena Torres", company: "Boutique Gala", duration: "02:15", status: "contestada", date: "Ayer, 2:10 PM", fabric: "lycra_metalica" },
  { id: "CALL-106", type: "entrante", agent: "Sistema IVR", client: "Desconocido", company: "Llamada Directa", duration: "00:45", status: "abandonada", date: "Ayer, 1:00 PM", fabric: null },
];
      ...
      <main className="flex-1 p-6 overflow-hidden flex flex-col gap-6">
        ...
        <div className="flex-none grid grid-cols-4 gap-4">
          <div className="bg-[#0a0a0a] border border-white/[0.03] p-5 rounded-3xl relative overflow-hidden group">
            <p className="text-[9px] uppercase font-black tracking-[0.2em] text-neutral-500 mb-2">Total Llamadas (Hoy)</p>
            <p className="text-3xl font-mono font-bold text-white">128</p>
          ...
          <div className="bg-[#0a0a0a] border border-white/[0.03] p-5 rounded-3xl">
            ...
            <p className="text-3xl font-mono font-bold text-emerald-500">92.4%</p>
          </div>
          <div className="bg-[#0a0a0a] border border-white/[0.03] p-5 rounded-3xl">
            <p className="text-[9px] uppercase font-black tracking-[0.2em] text-neutral-500 mb-2">Promedio Conversación</p>
            <p className="text-3xl font-mono font-bold text-[#FDCB02]">06:14</p>
          </div>
          <div className="bg-[#0a0a0a] border border-white/[0.03] p-5 rounded-3xl">
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-white/[0.02]">
                {callLogs
                  .filter(c => c.agent.toLowerCase().includes(searchTerm.toLowerCase()) || c.company.toLowerCase().includes(searchTerm.toLowerCase()))
                  .map((call, idx) => {
                      ...
                      >
                        <td className="px-8 py-6">
                          <div className="flex items-center gap-4">
                            <div className={`p-2.5 rounded-2xl ${
                              call.status === 'contestada' ? 'bg-white/5 text-neutral-400' : 'bg-red-500/10 text-red-500'
                            }`}>
                              {call.type === 'entrante' ? <PhoneIncoming size={16} /> : <PhoneOutgoing size={16} />}
                            </div>
                        ...
                        <td className="px-8 py-6 text-xs font-bold text-neutral-400">
                          <div className="flex items-center gap-2">
                             <div className="w-6 h-6 rounded-full bg-neutral-800 flex items-center justify-center border border-white/5 text-[10px] text-[#FDCB02]">
                        ...
                        <td className="px-8 py-6">
                          <div className="flex flex-col">
                            <span className="text-sm font-bold text-neutral-200">{call.client}</span>
                            <span className="text-[10px] text-neutral-500 uppercase tracking-widest">{call.company}</span>
                          </div>
                        </td>
