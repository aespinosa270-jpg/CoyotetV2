  ...
  return (
    <div className="h-full flex flex-col gap-4 overflow-hidden">
      <div className="shrink-0">
        <p className="text-[9px] tracking-[0.3em] text-zinc-500 uppercase mb-0.5">CRM / Asistencia</p>
        <h1 className="text-2xl font-black uppercase tracking-tighter text-zinc-900 italic">
          Reloj <span className="text-amber-500">Checador</span>
        </h1>
      </div>
      <CheckadorClient
