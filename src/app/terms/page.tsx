...
export default function TermsPage() {
  ...
  const handleDownloadPDF = () => {
    ...
    try {
      ...
      addText("• Procesamiento de Pagos Seguros: Se aceptan pagos mediante tarjetas de crédito y débito (Visa, Mastercard, American Express), así como pagos referenciados. Todas las transacciones son procesadas a través de la pasarela de pagos Stripe, garantizando el cumplimiento de los estándares de seguridad de la industria de tarjetas de pago (PCI DSS). Coyote Textil declara que no almacena, captura ni tiene acceso en sus servidores a los datos financieros completos del Cliente.");
