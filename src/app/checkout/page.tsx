...
// ============================================================================
// 💳 CONFIGURACIÓN DE PROVEEDORES DE FINANCIAMIENTO (SOLO APROBADOS)
// ============================================================================
...
// ============================================================================
// 💳 COMPONENTE: SECCIÓN DE FINANCIAMIENTO (ACTUALIZADA)
// ============================================================================
    ...
    <div className="space-y-4 animate-in fade-in slide-in-from-top-2 duration-300">
      <div className="flex items-center justify-between mb-2">
        ...
        <span className="text-[10px] text-neutral-400 uppercase tracking-widest font-bold">
          {FINANCING_PROVIDERS.length} opciones de crédito disponibles
        </span>
      </div>
              ...
              {step === 1 && (
                <motion.div key="step1" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="bg-white p-8 rounded-3xl border border-neutral-100 shadow-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <input placeholder="Código Postal" value={customerData.zip} maxLength={5} className="checkout-input-premium bg-[#FDCB02]/10 focus:bg-white border-[#FDCB02]/30 text-black font-bold placeholder:text-neutral-500" onChange={e => setCustomerData({...customerData, zip: e.target.value})}/>
                        ...
                        <input placeholder="Referencias" maxLength={30} value={customerData.reference} className="checkout-input-premium md:col-span-2" onChange={e => setCustomerData({...customerData, reference: e.target.value})}/>
                    </div>
                    <button 
                      ...
                      {wantsInvoice && (
                        <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="overflow-hidden">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pb-8">
                            ...
                            <input placeholder="Razón Social" value={fiscalData.razonSocial} className="checkout-input-premium uppercase" onChange={e => setFiscalData({...fiscalData, razonSocial: e.target.value.toUpperCase()})}/>
                ...
                <motion.div key="step4" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
                    ...
                    <div className="bg-[#111] p-8 rounded-3xl border border-neutral-800 shadow-2xl">
                      <Elements 
                        ...
                        options={{ 
                          ...
                          appearance: {
                            theme: 'night',
                            variables: { colorPrimary: '#FDCB02', colorBackground: '#050505', colorText: '#ffffff' }
                          }
                        }}
                      >
                  ...
                  <div className="relative flex items-center gap-4 py-2">
                    ...
                    <div className="flex items-center gap-2 bg-white border-2 border-dashed border-neutral-300 rounded-full px-4 py-2 shrink-0">
                      ...
                      <span className="text-[11px] font-[1000] uppercase tracking-widest text-neutral-500">O paga con financiamiento</span>
                      <Zap size={14} className="text-[#FDCB02] fill-[#FDCB02]"/>
                    </div>
                    <div className="flex-1 h-px bg-neutral-300"></div>
                  </div>
                  ...
                  <button onClick={() => setStep(3)} className="text-neutral-500 text-sm font-bold uppercase tracking-widest hover:text-black transition-colors flex items-center gap-2 pt-2">
